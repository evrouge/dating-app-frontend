  ...
  return (
    <Router>
      <div className="App">
        ...
        {/* <Router> */}
        <Routes>
          <Route path='/dating/messages' element=
            {<div><Header /> <Chat /> <Footer /></div>}
          >
          </Route>
          <Route path='/dating/edit' element=
            {<div><Header /> <Edit /> <Footer /></div>}
          >
          </Route>
          <Route path='/dating' element=
            {<div><Header /> <Cards getPeople={getPeople} people={people} /> <Footer /></div>}
          >
          </Route>
          <Route path='/' element={<Home getPeople={getPeople} handleCreate={handleCreate} />}>
          </Route>
        </Routes>
      </div>
    </Router>
